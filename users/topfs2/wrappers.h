...
#define _________________LOWER_L1___________________________       _______, _______, KC_9,    KC_8,    KC_NLCK, KC_7
#define _________________LOWER_L2___________________________       _______, KC_DOT,  KC_6,    KC_5,    KC_0,    KC_4
#define _________________LOWER_L3___________________________       _______, KC_COMM, KC_3,    KC_2,    KC_PSCR, KC_1

#define _________________LOWER_R1___________________________       _______, _______, KC_AMPR, KC_GT,   KC_LT,   _______
#define _________________LOWER_R2___________________________       _______, KC_EQL,  KC_EXLM, KC_PPLS, KC_PMNS, _______
#define _________________LOWER_R3___________________________       _______, _______, KC_PIPE, KC_PAST, KC_PSLS, _______


#define _________LOWER_RT________                                  KC_ENT,  _______, _______


#define _________________RAISE_L1___________________________       _______, KC_TILD, KC_GRV,  KC_SLSH, KC_PERC, _______
#define _________________RAISE_L2___________________________       _______, KC_HASH, KC_DLR,  KC_AT,   KC_CIRC, _______
#define _________________RAISE_L3___________________________       _______, _______, _______, _______, KC_UNDS, _______

#define _________________RAISE_R1___________________________       KC_DOWN, KC_RGHT, KC_RCBR, KC_LCBR, KC_DQT,  _______
#define _________________RAISE_R2___________________________       KC_LEFT, KC_SCLN, KC_RBRC, KC_I,    KC_LBRC, _______
#define _________________RAISE_R3___________________________       KC_UP,   KC_COLN, KC_RPRN, KC_LPRN, KC_QUOT, _______


#define _________________MODL_L1____________________________       _______, _______, _______, _______, KC_TAB,  _______
#define _________________MODL_L2____________________________       _______, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, KC_ESC
#define _________________MODL_L3____________________________       ___________________BLANK____________________________
...
#define _________________MODR_R1____________________________       _______, KC_TAB,  _______, _______, _______, _______
#define _________________MODR_R2____________________________       KC_ESC,  KC_RGUI, KC_RALT, KC_RSFT, KC_RCTL, _______
#define _________________MODR_R3____________________________       ___________________BLANK____________________________
...
#define _________________ADJUST_R1__________________________       ___________________BLANK____________________________
#define _________________ADJUST_R2__________________________       ___________________BLANK____________________________
#define _________________ADJUST_R3__________________________       ___________________BLANK____________________________
