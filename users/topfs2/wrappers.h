...
#define _________________LOWER_L1___________________________       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6
#define _________________LOWER_L2___________________________       _______, KC_P1,   KC_P2,   KC_P3,   KC_P4,   KC_P5
#define _________________LOWER_L3___________________________       _______, KC_P6,   KC_P7,   KC_P8,   KC_P9,   KC_P0

#define _________________LOWER_R1___________________________       KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12
#define _________________LOWER_R2___________________________       _______, KC_PEQL, KC_PLUS, KC_ASTR, KC_MINS, _______
#define _________________LOWER_R3___________________________       _______, KC_BSLS, _______, _______, KC_GRV,  _______
...
#define _________________RAISE_L2___________________________       _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC
#define _________________RAISE_L3___________________________       _______, KC_CIRC, _______, _______, KC_UNDS, _______

#define _________________RAISE_R1___________________________       KC_DOWN, KC_RGHT, KC_LCBR, KC_RCBR, _______, _______
#define _________________RAISE_R2___________________________       KC_LEFT, KC_AMPR, KC_LPRN, KC_RPRN, KC_UNDS, _______
#define _________________RAISE_R3___________________________       KC_UP,   KC_PIPE, KC_LBRC, KC_RBRC, KC_TILD, _______
...
#define _________________ADJUST_R1__________________________       KC_PGDN, KC_END,  _______, _______, _______, _______
#define _________________ADJUST_R2__________________________       KC_HOME, _______, _______, _______, _______, _______
